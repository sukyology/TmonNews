...
@Service
public class ParsingAndInsertReviewBO {
	private static String appReviewsUrl = "http://10.5.220.81:8080/social/appReview.tmon";

	public List<AppReviewModel> getAppReviewListSpecificDate(String startDate, String endDate) throws IOException, ParseException, java.text.ParseException {
		String url = appReviewsUrl + "?startdate=" + startDate + "&enddate=" + endDate;
		Iterator<JSONObject> arrayIterator = getArrayIterator(url);
	...
	public List<AppReviewModel> getAppReviewListAmongLastestWeek() throws IOException, ParseException, java.text.ParseException {
		Iterator<JSONObject> arrayIterator = getArrayIterator(appReviewsUrl);
	...
	private Iterator<JSONObject> getArrayIterator(String url) throws IOException, ParseException {
